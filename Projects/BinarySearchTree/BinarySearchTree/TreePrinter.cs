...
namespace BinarySearchTree
{
    class TreePrinter
    {
        public static void PrintChildNodes(Node root)
        {
        ...
        private static void PrintNodeInternal(List<Node> nodeList, int level, int maxLevel)
        {
        ...
        private static bool IsAllElementsNull(List<Node> nodeList)
        {
            foreach(Node node in nodeList)
            {
                if (node != null)
